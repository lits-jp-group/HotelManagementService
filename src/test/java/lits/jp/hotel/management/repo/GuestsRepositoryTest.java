...
public class GuestsRepositoryTest {
    ...
    public void whenFindByName_thenReturnGuests() {
       ...
       guestToBeFound.setLastName("Beam");
        ...
        // when
        Iterable<Guests> iterableGuestsByName = guestsRepository.findByFirstName(guestToBeFound.getFirstName());
        ...
        // then
        assertThat(guestFound.getFirstName())
                .isEqualTo(guestToBeFound.getFirstName());
    }
}
